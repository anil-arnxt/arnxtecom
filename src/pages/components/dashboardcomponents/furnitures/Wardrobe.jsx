...
<div className='w-full flex flex-row'>
                ...
                <div className='w-full p-2 flex flex-col justify-start items-start  gap-1 '>
                    <label className='text-md text-gray-500 font-normal'>Back material</label>
                    <select className='w-full  border-2 rounded-xl outline-none p-2' name='backmaterialtype' onChange={handleinputchange}>
                        <option disabled selected>select</option>
                        {
                            backmaterialtype.map(item=>(
