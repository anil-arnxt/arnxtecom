...
const Microwave = () => {
    ...
    const capacity = [ "Up to 20 l",
        "21 - 25 l",
        "26 - 30 l",
        "31 l & More"]
    
      const heatingtype = [ "Convection",
        "Grill",
        "Solo Microwave"]
...
<div className='w-full flex flex-row'>
                <div className='w-full p-2 flex flex-col justify-start items-start  gap-1 '>
                    <label className='text-md text-gray-500 font-normal'>Capacity</label>
                    <select className='w-full  border-2 rounded-xl outline-none p-2' name='capacity' onChange={handleinputchange} >
                ...
                <div className='w-full p-2 flex flex-col justify-start items-start  gap-1 '>
                    <label className='text-md text-gray-500 font-normal'>Heating type</label>
                    <select className='w-full  border-2 rounded-xl outline-none p-2' name = 'heatingtype' onChange={handleinputchange}>
                        <option disabled selected>select</option>
                ...
                <div className='w-full p-2 flex flex-col justify-start items-start  gap-1 '>
                    <label className='text-md text-gray-500 font-normal'>Installation type</label>
                    <select className='w-full  border-2 rounded-xl outline-none p-2' name = 'installationtype' onChange={handleinputchange}>
                        <option disabled selected>select</option>
