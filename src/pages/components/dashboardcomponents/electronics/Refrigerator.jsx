...
<div className='w-full flex flex-row'>
                <div className='w-full p-2 flex flex-col justify-start items-start  gap-1 '>
                    <label className='text-md text-gray-500 font-normal'>Star</label>
                    <select className='w-full  border-2 rounded-xl outline-none p-2' name='star' onChange={handleinputchange} >
                ...
                <div className='w-full p-2 flex flex-col justify-start items-start  gap-1 '>
                    <label className='text-md text-gray-500 font-normal'>Configuration</label>
                    <select className='w-full  border-2 rounded-xl outline-none p-2' name = 'configuration' onChange={handleinputchange}>
                        <option disabled selected>select</option>
