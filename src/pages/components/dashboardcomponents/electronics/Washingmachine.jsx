...
const Washingmachine = () => {
    ...
    const type = ["Frontload", "Topload"]
    
      const operation = ["Semi Automatic", "Fully Automatic"]
...
<div className='w-full flex flex-row'>
                <div className='w-full p-2 flex flex-col justify-start items-start  gap-1 '>
                    <label className='text-md text-gray-500 font-normal'>Type</label>
                    <select className='w-full  border-2 rounded-xl outline-none p-2' name='type' onChange={handleinputchange} >
                ...
                <div className='w-full p-2 flex flex-col justify-start items-start  gap-1 '>
                    <label className='text-md text-gray-500 font-normal'>Operation</label>
                    <select className='w-full  border-2 rounded-xl outline-none p-2' name = 'operation' onChange={handleinputchange}>
                        <option disabled selected>select</option>
