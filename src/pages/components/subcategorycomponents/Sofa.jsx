                  ...
                  filterData && filterData.map((product,index)=>(
                    ...
                    <div className='relative top-5 flex justify-between mb-4'>
    ...
    
                      {
                                 ...
                                 <div>
                                    <p className='text-xs'>   { Math.round( (Number(product.mrp) - Number(product.offerprice) )/ Number(product.mrp)*100)}%</p>
            ...
            : product.productname.toUpperCase()}
                    ...
                    <div className='flex flex-row justify-between mt-2'>
    
                        {
                            ...
                            <p className='mt-2  text-gray-500 line-through '>₹ {product.mrp} </p>
                            <p className='mt-2 font-bold '>₹ {product.offerprice} </p>
