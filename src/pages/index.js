    ...
    <div>
      ...
      <div className=" flex flex-row w-100 flex-wrap justify-between p-10 items-center mt-10 mb-10">
        <div className="h-auto w-[350px] shadow-lg rounded-xl p-2">
          <Image
            ...
            height={600}
          />
          <p className="text-xl font-bold mt-2 text-zinc-400">
      ...
      <div className=" flex flex-row w-100 flex-wrap justify-center p-10 items-center mt-10 mb-10">
        ...
        <div className="h-auto w-[350px] shadow-lg rounded-xl p-2 m-5">
          ...
          <div className="flex flex-col">
            <p className="text-l font-bold mt-2 text-zinc-400">
      ...
      <div className="container mx-auto flex w-100 justify-between flex-wrap p-5 mt-10 mb-10">
        <h2 className="text-xl text-black-400 font-bold">Featured Products</h2>
      ...
      <div className="container mx-auto flex flex-wrap w-100 justify-between items-center mt-10 mb-10">
        <div className="h-auto w-[250px] shadow-lg rounded-xl p-2">
          <div className="relative top-5 flex justify-between mb-4">
            <button className="w-auto bg-red-300 rounded-3xl p-1 ">10%</button>
          ...
          <div className="flex flex-row justify-between mt-2">
            ...
            <button className="rounded-xl bg-green-300 p-2">Buy now</button>
          </div>
        </div>
        <div className="h-auto w-[250px] shadow-lg rounded-xl p-2">
          <div className="relative top-5 flex justify-between mb-4">
            <button className="w-auto bg-red-300 rounded-3xl p-1 ">30%</button>
            <Heart className="cursor-pointer" />
          </div>
          <Image
            src="/images/washingmachine.png"
        ...
        <div className="h-auto w-[250px] shadow-lg rounded-xl p-2">
          <div className="relative top-5 flex justify-between mb-4">
            <button className="w-auto bg-red-300 rounded-3xl p-1 ">20%</button>
            <Heart className="cursor-pointer" />
          </div>
          <Image
            src="/images/washingmachine.png"
